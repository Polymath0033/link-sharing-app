...
export default function Login() {
  ...
  return (
    <AuthComponent title="Login" submitHandler={submitHandler}>
      <InputUI
        type="email"
        value={email}
      ...
      <ButtonUI value="Login" type="submit" />
      <span className="text-center font-normal text-sm text-dark-gray">Don't have an account? <Link href="/auth/sign-up" className="text-purple">Create an account</Link> </span>
    </AuthComponent>
  );
}
